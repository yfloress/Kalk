...
pub const EN: Messages = Messages {
    ...
    import_step1_copy: "Copy",
    import_step1_copied: "Copied to clipboard",
    import_step1_next: "Continue",
    import_step1_fullscreen: "Fullscreen",
    import_step1_fullscreen_exit: "Back",
...
Example 2 — a course that uses the harder rules.  Note that a rule and its
action always travel together, and that "cap_final_grade" is only meaningful
next to an action that names it:
...
"#,
    ...
    welcome_fonts_hint: "Choose No if you see boxes or question marks.",
    welcome_yes: "Yes",
    welcome_no: "No",
    welcome_next: "Continue",
    welcome_start: "Start",
    welcome_back: "Back",
    metric_global: "Global",
    metric_pending_word: "pending",
    metric_minimums: "Minimums",
    metric_unmet_word: "unmet",
